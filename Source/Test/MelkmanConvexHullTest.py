...
class MelkmanCHTest( unittest.TestCase ):
    ...
    def test_simple( self ):
        ...
        chExpected = [ vector([6,1]), vector([4,5]), vector([-2,4]), vector([-4,-2]) ]
    ...
    def test_hull_complex( self ):
        ...
        chExpected = [vector([ 55.90910339, -67.72727203]), vector([105.90910339,  12.27272606]), vector([65.90910339, 52.27272797]), vector([ 5.90910339, 72.27272797]), vector([-44.09089661,  62.27272797]), vector([-84.09089661, -17.72727394]), vector([-64.09089661, -47.72727203]), vector([ 15.90910339, -67.72727203])]
        self.compareHulls( verts, chExpected )
